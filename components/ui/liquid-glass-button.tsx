    ...
    <>
      {asChild ? (
        <Comp
          ...
          {...props}
        >
          <span className="relative inline-flex w-full items-center justify-center">{content}</span>
        </Comp>
      ) : (
        <Comp
          data-slot="button"
...
const metalButtonVariants = (
  ...
  return {
    ...
    button: cn(
      "relative z-10 m-[1px] inline-flex h-11 transform-gpu cursor-pointer items-center justify-center overflow-hidden rounded-md rounded-md px-6 py-2 text-sm font-semibold leading-none will-change-transform outline-none",
      colors.button,
      colors.textColor,
      colors.textShadow
    ),
